                    ...
                    <form action="atualiza_aluno.php?ra= <?php echo $ra;?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="nome" value="<?php 
                                echo $linha['nome'];
                                ?>"
                                 class="form-control">
                            </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="email" id="email-input" name="email" value="<?php 
                                echo $linha['email'];
                                ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="telefone" value="<?php 
                                echo $linha['tel'];
                                ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="celular" value="<?php 
                                echo $linha['celular'];
                                ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="date" id="text-input" name="nascimento" value="<?php 
