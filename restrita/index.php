                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <td>
                                                <a href="form_atualiza_aluno.php?ra= <?php echo $linha['ra']; ?>" class="btn btn-primary">ATUALIZA</a>
                                                &nbsp; &nbsp;
                                                <a href="form_deleta_aluno.php?ra= <?php echo $linha['ra']; ?>" class="btn btn-danger">APAGAR</a>
                                            </td>
